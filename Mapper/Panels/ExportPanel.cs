	...
	class ExportPanel : UIPanel
	{
		...
		private void ButtonGenerate_eventClicked(UIComponent component, UIMouseEventParameter eventParam)
		{
			...
			try
			{
				...
				if (_modPath != null && _modPath != string.Empty && _fullOSMPath != null && _fullOSMPath != string.Empty)
				{
					...
					if (_extractedMaperitivePath != null && _extractedMaperitivePath != string.Empty && GzipExtractor.RemoveAllChangedNames(_zippedMaperitivePath, _extractedMaperitivePath, ".mapper"))
					{
